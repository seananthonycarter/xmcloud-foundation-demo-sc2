...
Add-HostsEntry "www.sxademosite1.localhost"
...
if ($InitEnv) {
    ...
    Set-EnvFileVariable "RENDERING_HOST_SXADEMOSITE1" -Value "www.sxademosite1.localhost"
